...
class MuonAdamW(torch.optim.Optimizer):
    ...
    def _step_muon(self, group: dict) -> None:
        ...
        shape, device, dtype = first_param.shape, first_param.device, first_param.dtype
...
def create_optimizer(model: torch.nn.Module, settings: object) -> MuonAdamW:
    return model.setup_optimizer(
        ...
        adam_betas=settings.adam_betas,
        scalar_lr=settings.scalar_lr,
    )
